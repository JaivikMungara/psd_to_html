...
namespace mainproject.Controllers
{
    ...
    {
        private readonly helperland_project1Context _db;

        public AdminController(helperland_project1Context db)
        {
            _db = db;
        }
        ...
        public async Task<IActionResult> CencleServiceReq(ServiceRequest cancel)
        {
            ...
            if (result != null)
            {
                ...
                await Task.Run(() =>
                {
                    ...
                    mailto: client.Authenticate("helperland12345@gmail.com", "password@34");
                        client.Send(message);
